...
const PengaduanMahasiswa = React.lazy(() => import('./views/pengaduan/PengaduanMahasiswa'))
...
const routes = [
  ...
  { path: '/pengaduanmahasiswa', name: 'PengaduanMahasiswa', element: PengaduanMahasiswa },
